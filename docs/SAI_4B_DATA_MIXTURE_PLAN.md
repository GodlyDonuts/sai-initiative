...
| [Dolma 3 150B Mix sample](https://huggingface.co/datasets/allenai/dolma3_mix-150B-1025) | `afa92bfb22366821c5e6cd427cdd036b34b713ef` | ODC-By, public; exact API head resolved 2026-08-22 | Modern bounded multi-domain candidate. Its card reports 76.9% Common Crawl, 12.6% science PDFs, 7.06% Stack-Edu, 2.60% FineMath, 0.82% arXiv, and 0.04% Wikipedia/Wikibooks. Replay each component, source/license obligation, filter, and cross-component duplicate identity; do not admit the blend opaquely. |
| [Dolma 3 Dolmino 100B Mix](https://huggingface.co/datasets/allenai/dolma3_dolmino_mix-100B-1025) | `f23942ae8a8114af6e992efe8188ce8c531acd16` | ODC-By, public; exact API head resolved 2026-08-22 | Mid-training ablation only. The published mix contains synthetic math, code, QA, instruction, and reasoning traces alongside Stack-Edu, science PDFs, STEM crawl, and high-quality web. Preserve every component/generator identity and compare it after the base mixture; never substitute the aggregate for foundational data. |
...
The exact Dolma 3 reconstruction-code head observed on 2026-08-22 is
`1a9daced81670e0fa768e47fbed32af6694a1865`; its Apache-2.0 code license is not
a substitute for the terms or provenance of the reconstructed data. The 150B
