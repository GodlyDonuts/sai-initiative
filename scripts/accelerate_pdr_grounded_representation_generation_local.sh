...
# reverse-order companion can safely use six additional slots because every
...
# contract, so completed shard summaries remain aggregate-compatible.
export SAI_OPENROUTER_SHARED_PROVIDER_CONCURRENCY=12
